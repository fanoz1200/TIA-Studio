...
1. لا تختلق حالات مطالبات أو نتائج تحليل أو فيديوهات. استخرجت ملفات المستخدم 27 مرجع FIDIC و5 سيناريوهات تدريبية، لكنها لم تقدم حالات D-056 إلى D-088 كسجلات منظمة؛ لذلك تظل هذه الحالات بانتظار ملف Excel فعلي.
