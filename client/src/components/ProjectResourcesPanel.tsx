...
const resources = [
  ...
  { title: "نسخة سطح المكتب — Windows 1.0.9 Setup (الموصى بها)", description: "مثبّت Windows x64 يتضمن Claim Console وتدقيق تقاويم/قيود XER: اضغط Download ثم شغّل ملف Setup مرة واحدة. يضيف اختصاراً في Start ويثبت التطبيق في مكانه الطبيعي؛ لا تحتاج Node.js أو فك ضغط. الحزمة غير موقّعة رقمياً: افحصها قبل التشغيل من هذا الرابط الرسمي فقط.", href: "https://github.com/fanoz1200/TIA-Studio/releases/download/v1.0.9/TIA-Studio-1.0.9-Windows-x64-Setup.exe", icon: HardDriveDownload, kind: "Windows x64 · Setup" },
  { title: "نسخة سطح المكتب — Windows 1.0.9 المحمولة", description: "ملف EXE مباشر يتضمن Claim Console وتدقيق تقاويم/قيود XER ولا يثبت شيئاً ولا يضيف أيقونة Start؛ شغّله من مجلد تختاره أنت. مناسب للتجربة أو عند منع التثبيت في جهاز العمل، لكنه لا يوفر تثبيتاً مركزياً أو تحديثاً تلقائياً.", href: "https://github.com/fanoz1200/TIA-Studio/releases/download/v1.0.9/TIA-Studio-1.0.9-Windows-x64-Portable.exe", icon: HardDriveDownload, kind: "Windows x64 · EXE محمول" },
  { title: "بصمات Windows 1.0.9 — SHA-256", description: "ملف بصمات Setup وPortable. نزّله ثم طابق البصمة قبل التشغيل، ولا تخلط ملفاً من إصدار أو مصدر تنزيل مختلف.", href: "https://github.com/fanoz1200/TIA-Studio/releases/download/v1.0.9/TIA-Studio-1.0.9-Windows-x64-SHA256SUMS.txt", icon: ShieldCheck, kind: "SHA-256" },
  ...
  return <div className="view-stack resources-view">
    ...
    <section className="desktop-download-quick" aria-label="تنزيل نسخة الكمبيوتر">
      ...
      <div className="desktop-download-quick__actions">
        <a className="desktop-download-quick__primary" href={resolveResourceDownloadHref(resources[7].href)} download><Download size={17} />Windows 1.0.9 — Setup</a>
        <a className="desktop-download-quick__secondary" href={resolveResourceDownloadHref(resources[8].href)} download><Download size={17} />Windows 1.0.9 — محمول</a>
      </div>
    </section>
