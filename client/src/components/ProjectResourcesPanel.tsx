...
const resources = [
  ...
  { title: "نسخة سطح المكتب — Windows 1.0.4", description: "ملف EXE محمول واحد يفتح البرنامج مباشرة على Windows x64؛ يحتوي إصلاح بدء الخادم المضمّن ومراجع FIDIC والسيناريوهات التعليمية الجديدة. لا يحتاج تثبيت Node.js أو فك ZIP. غير موقّع رقمياً: افحصه ببرنامج الحماية ثم ابدأ بمشروع تدريبي قبل أي ملف حقيقي.", href: "/manus-storage/TIA-Studio-1.0.4-Windows-x64-Complete_cdfb8335.exe", icon: HardDriveDownload, kind: "Windows x64 · EXE محمول" },
  { title: "نسخة سطح المكتب — Linux 1.0.4", description: "ملف AppImage واحد يفتح البرنامج محلياً على Linux x64، ويشمل مراجع FIDIC والسيناريوهات التعليمية الجديدة. امنحه صلاحية التنفيذ مرة واحدة، ثم افتحه واستخدم مشروعاً تدريبياً للتحقق قبل الاستخدام المهني.", href: "/manus-storage/TIA-Studio-1.0.4-Linux-x64-Complete_5e0f37b6.AppImage", icon: HardDriveDownload, kind: "Linux x64 · AppImage" },
];
