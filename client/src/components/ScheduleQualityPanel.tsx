...
export function ScheduleQualityPanel({ view, schedule, xerSummary, onNavigate }: Props) {
  ...
  const hasPreservedXer = Boolean(schedule.xerSource?.rawText);
