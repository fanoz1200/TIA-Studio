...
const notFoundCopy = {
  ar: {
    ...
    detail: "قد يكون تم نقلها أو حذفها.",
...
export default function NotFound() {
  ...
  return (
    <div dir={direction} className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100">
