...
export const releaseChanges = [
  ...
  "تحقق تشغيل Windows للإصدار 1.0.3: شُغّل ملف EXE في بيئة Windows معزولة عبر Wine مع ملف مستخدم مؤقت، ونجح الخادم المحلي في الاستجابة من المنفذ 4317. يظل فحص SmartScreen والطابعات وأجهزة Windows الفعلية خارج نطاق هذا الاختبار المعزول.",
