export const releaseInfo = {
  ...
  launcher: "Windows: ملف TIA-Studio-1.0.7-Windows-x64.exe واحد. Linux: ملف TIA-Studio-1.0.7-Linux-x64.AppImage واحد.",
} as const;
...
export const engineGuide = [
  { name: "قارئ P6 XER / XML وXER Viewer", input: "ملف البرنامج والملاحظات وWBS ونسب الإنجاز والموارد والتكاليف المتاحة", output: "نموذج جدول موحد وقراءة محلية للفروق قبل الرجوع إلى Primavera" },
  { name: "محرك CPM الحتمي والتقويم الإقليمي", input: "الأنشطة والعلاقات والتقويم والبلد والإجازات المراجَعة", output: "ES/EF/LS/LF وTotal Float والمسار الحرج" },
...
export const workflowGuide = [
  ...
  "افتح عارض XER لقراءة الأنشطة والعلاقات وWBS والتقويم وفروق النسخ محلياً؛ هو للمراجعة وليس بديلاً عن Primavera.",
  "أكمل بوابة الجودة بعد Baseline وUpdate: راجع الأنشطة والعلاقات وData Date والتقويم قبل إدخال Excel أو إنشاء Fragnet.",
...
export const systemLinks = [
  "الاستيراد وXER Viewer يزوّدان محرك CPM وبوابة الجودة بالبيانات نفسها، فلا توجد أرقام مخفية أو حسابات خارجية.",
